...
var Confirm = {
    ...
    init: function(size) {
        ...
        ElemHtml = '<div id="confirm-modal" class="modal fade role="dialog">' + '<div class="modal-dialog modal-' + size + '" align="center">' + '<div class="modal-content" id="checkDel" style="width: 400px">' + '<div class="modal-header">' + '<button id="modal-upper-close" class="close modal-close" aria-label="Close" type="button">' + '<span aria-hidden="true">×</span>' + '</button>' + '<h4 id="modal-title" class="modal-title"></h4>' + '</div>' + '<div id="modal-body" class="modal-body"></div>' + '<div id="modal-footer" class="modal-footer">' + '</div>' + '</div>' + '</div>' + '</div>' + '<div id="modal-background" class=""></div>';
    ...
    addCustomButtons: function() {
        ...
        $.each(self.customButton, function(key, val) {
            ...
            if (buttonName.toLowerCase() == 'delete' || buttonName.toLowerCase() == 'remove')
            ElemHtml = closeButton + '<button id="button-' + buttonName.toLowerCase() + '" type="button" class="btn modal-custom-button ' + ButtonState + '">' + "删除" + '</button>';
            if (buttonName.toLowerCase() == 'okay' || buttonName.toLowerCase() == 'ok')
            ElemHtml = closeButton + '<button id="button-' + buttonName.toLowerCase() + '" type="button" class="btn modal-custom-button ' + ButtonState + '">' + "确定" + '</button>';
